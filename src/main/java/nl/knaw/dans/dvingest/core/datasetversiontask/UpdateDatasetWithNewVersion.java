...
/**
 * Updates an existing dataset, resulting in a new version of the dataset.
 */
@Slf4j
public class UpdateDatasetWithNewVersion extends AbstractDatasetVersionTask {

    public UpdateDatasetWithNewVersion(Deposit deposit, DataverseService dataverseService, UtilityServices utilityServices, Path outputDir) {
